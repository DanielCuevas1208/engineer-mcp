...
- Fatigue analysis for cyclic loads. The `fatigue_analysis` tool returns the Soderberg, Goodman, Gerber, and ASME-elliptic safety factors with a Marin-corrected endurance limit.
