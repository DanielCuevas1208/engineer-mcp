...
const TOOL_SCHEMAS: Record<string, ToolDef> = {
  ...
  fatigue_analysis: {
    description:
      "Fatigue safety factor, corrected endurance limit, and predicted life for a fluctuating stress state. Supports Goodman, Gerber, Soderberg, and ASME-elliptic criteria.",
