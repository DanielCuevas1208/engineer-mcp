...
const TOOL_SCHEMAS: Record<string, ToolDef> = {
  ...
  fatigue_analysis: {
    description:
      "Fatigue safety factors for fluctuating stress using the Soderberg, Goodman, Gerber, and ASME-elliptic criteria, with a Marin-corrected endurance limit and an S-N life estimate.",
