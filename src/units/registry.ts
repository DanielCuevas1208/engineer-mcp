...
export const UNITS: UnitDef[] = [
  ...
  unit({
    canonical: "Pa.s",
    aliases: ["Pa·s", "Pas", "pascal second"],
    name: "pascal second",
    category: "dynamic_viscosity",
    dim: DIM_DYNAMIC_VISCOSITY,
    factor: 1,
  }),
  unit({
    canonical: "mPa.s",
    aliases: ["mPa·s", "cP", "centipoise"],
  ...
  unit({
    canonical: "lbm/fts",
    aliases: ["lb/fts", "lb/(ft·s)", "lb/(ft.s)", "lbm/(ft·s)"],
    name: "pound mass per foot second",
    category: "dynamic_viscosity",
    dim: DIM_DYNAMIC_VISCOSITY,
    factor: 1.48816394357,
  }),

  unit({
    canonical: "m2/s",
    name: "square metre per second",
    category: "kinematic_viscosity",
    dim: DIM_KINEMATIC_VISCOSITY,
    factor: 1,
  }),
  unit({
    canonical: "mm2/s",
    aliases: ["cSt", "centistokes"],
    name: "square millimetre per second",
    category: "kinematic_viscosity",
    dim: DIM_KINEMATIC_VISCOSITY,
    factor: 1e-6,
  }),
  ...
  unit({
    canonical: "W/mK",
    aliases: ["W/m·K", "W/m/K", "W/(mK)"],
    name: "watt per metre kelvin",
    category: "thermal_conductivity",
    dim: DIM_THERMAL_CONDUCTIVITY,
    factor: 1,
  }),
  unit({
    canonical: "mW/mK",
    aliases: ["mW/m·K", "mW/m/K"],
